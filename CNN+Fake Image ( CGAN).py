...
X_train_full = np.load('fake_mnist_images_train.npy')  # shape: (n, 28, 28, 1)
y_train_full = np.load('fake_mnist_labels_train.npy')  # shape: (n,)
X_test = np.load('fake_mnist_images_test.npy')
y_test = np.load('fake_mnist_labels_test.npy')
...
X_train_cnn = (X_train + 1) / 2.0
X_val_cnn   = (X_val + 1) / 2.0
X_test_cnn  = (X_test + 1) / 2.0
